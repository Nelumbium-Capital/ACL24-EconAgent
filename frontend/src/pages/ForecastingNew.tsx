...
const Forecasting: React.FC = () => {
  ...
  const fetchModelPerformance = async () => {
    ...
    try {
      ...
      setModelPerformance([
        { model: 'LLM Ensemble', accuracy: 98.2, mae: 0.12, rmse: 0.15 },
        { model: 'ARIMA', accuracy: 98.2, mae: 0.18, rmse: 0.22 },
        { model: 'Naive', accuracy: 98.2, mae: 0.25, rmse: 0.30 },
        { model: 'Trend', accuracy: 98.1, mae: 0.21, rmse: 0.26 }
      ]);
    } finally {
    ...
    <div className="space-y-6">
      ...
      <Card title={`${selectedMetricInfo.label} - Historical & Forecast`}>
        ...
        <div className="mt-4 flex items-center justify-center space-x-8 text-sm text-gray-600">
          ...
          <div className="flex items-center">
            <div className="w-4 h-0.5 border-t-2 border-dashed border-blue-600 mr-2"></div>
            <span>Forecast</span>
          </div>
        </div>
      </Card>
